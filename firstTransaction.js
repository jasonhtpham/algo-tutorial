...
const createAccount = function () {
  try {
    const myaccount = {
      addr: "TA6ZNLM5GK6NS453PFS7Z6KO4PYEOY4GBM4WZQPGD5PABWSWIFJ2WTSJNU",
      sk: "",
      mnemonic: "inquiry club level file immense pigeon shy salon usual gather inhale dinner core practice forum super agree crumble lawsuit leave enough peasant rule absorb then",
    };
    console.log("Account Address = " + myaccount.addr);
    // let account_mnemonic = algosdk.secretKeyToMnemonic(myaccount.sk);
    myaccount.sk = algosdk.mnemonicToSecretKey(myaccount.mnemonic).sk;
